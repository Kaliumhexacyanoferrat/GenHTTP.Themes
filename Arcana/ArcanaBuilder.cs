...
namespace GenHTTP.Modules.Themes.Arcana
{
    ...
    {
        private string? _Title, _Copyright, _Footer1Title, _Footer2Title, _Description;
        ...
        public ArcanaBuilder Description(string description)
        {
        ...
        public ITheme Build()
        {
            return new ArcanaTheme(_Title, _Copyright, _Footer1Title, _Footer1?.Build(), _Footer2Title, _Footer2?.Build(), _Description);
        }
